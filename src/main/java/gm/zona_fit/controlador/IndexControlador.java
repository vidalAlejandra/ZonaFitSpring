...
public class IndexControlador {
    ...
    public void guardarCliente(){
        ...
        if(this.clienteSeleccionado.getId() == null){
            ...
            FacesContext.getCurrentInstance().addMessage(null,
                    new FacesMessage("Cliente Ingresado"));
        }
        //Modificar (upadte)
        else {
            this.clienteServicio.guardarCliente(this.clienteSeleccionado);
        ...
        //Reset del objeto cliente seleccionado, para dejarlo nulo, y hacer la diferencia para insertar o modificar
    ...
    public void eliminarCliente(){
        ...
        // eliminar el registro de la lista de cliente que esta en menoria
